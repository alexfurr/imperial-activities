...
//--------------
    function drawCanvas($atts)
	{
		...
		$str.='<div class="tab-wrap">';
      $str.='<input id="tab1" type="radio" name="tabs" checked><label for="tab1" id="drawing-mode_' .$canvasID. '">Drawing mode</label>';
	//	$str.='<input id="tab2" type="radio" name="tabs"><label id="text-canvas_' .$canvasID. '" for="tab2">Text mode</label>';
      $str.='<input id="tab2" type="radio" name="tabs"><label for="tab2" id="move-mode_' .$canvasID. '">Move mode</label>';
        ...
        <button id="text-canvas_' .$canvasID.'" class="btn btn-info" title="Add Text"><i class="fa fa-font"></i></button>
